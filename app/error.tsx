  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-slate-950 p-6 text-slate-100">
      <section className="glass-panel max-w-lg rounded-lg p-6">
        ...
        <p className="mt-3 text-sm text-slate-300">{error.message || "An unexpected dashboard error occurred."}</p>
        <button
          type="button"
          onClick={reset}
          className="mt-5 rounded-lg border border-cyan-300/30 bg-cyan-300/15 px-4 py-2 text-sm font-semibold text-cyan-50"
        >
          Restart dashboard
        </button>
      </section>
