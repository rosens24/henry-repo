...
export function ChatPanel({ messages, isLoading }: ChatPanelProps) {
  return (
    <section className="max-h-[340px] overflow-hidden rounded-md border border-yellow-300/15 bg-black/55 p-3 lg:max-h-[420px]">
      ...
      <div className="flex max-h-[260px] flex-col gap-3 overflow-y-auto pr-1 lg:max-h-[340px]">
        ...
        {isLoading ? (
          <div className="data-rail inline-block w-fit rounded-md border border-yellow-300/20 bg-yellow-400/10 px-3 py-2 text-sm text-yellow-50">
